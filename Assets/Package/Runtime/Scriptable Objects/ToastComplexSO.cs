...
{
    [CreateAssetMenu(fileName = "ToastComplexSO", menuName = "ScriptableObjects/Toasts/ToastComplexSO")]
    public class ToastComplexSO : ScriptableObject
    {
        ...
        [TextArea(1, 10), Tooltip("The [SecondaryMessage] label of the toast")]
